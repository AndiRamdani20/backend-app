...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{asset('css/material-kit.css?v=3.0.3')}}" rel="stylesheet" />
...
<body>
  ...
  <div class="page-header align-items-start min-vh-100" style="background-image: url('https://images.unsplash.com/photo-1497294815431-9365093b7331?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80');" loading="lazy">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            ...
            <div class="card-body">
                <form method="POST" role="form" action="{{ url('user/login') }}" class="text-start">
                    @csrf
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn bg-gradient-primary w-100 mb-2">Register</button>
                    </div>
                </form>
                @if ($error != '')
    ...
    <!--  Google Maps Plugin    -->
    <script src="{{asset('js/material-kit.min.js?v=3.0.3')}}" type="text/javascript"></script>
